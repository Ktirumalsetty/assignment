...
public class RecyclerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(@NonNull Canvas c, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
        ...
        if(headerView==null)
        {
            ...
            tvTitle = (TextView)headerView.findViewById(R.id.tv_sec_name);
    ...
    {
        View view= LayoutInflater.from(context).inflate(R.layout.section_header_item,recyclerView,false);
        return view;
    }
